    ...
    const handleLogin = async (e: any) => {
        ...
        try {
            ...
            if (response.data?.success === true) {
                ...
                // token store
                localStorage.setItem("schooltoken", response.data.data);

                // user object store
                localStorage.setItem("schooluser", JSON.stringify(response.data.user));
                ...
                <div className="lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-8 md:p-12 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg text-white/90 max-w-sm">
                            Complete school management platform with attendance, grades, fees, and real-time parent-teacher communication.
                        </p>
                        ...
                        <div className="mt-8 space-y-2">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="text-green-300 font-mono">2,451 ▲ 12%</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-white/80">Qualified Teachers</span>
                                <span className="text-green-300 font-mono">186 ▲ 5%</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-white/80">Passing Rate</span>
                    ...
                    <div className="mt-12 lg:mt-0 relative z-10">
                        <div className="flex items-center gap-4 p-4 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 transition-all duration-300 hover:bg-white/20 cursor-default">
                            ...
                            <div>
                                <p className="font-semibold text-white text-lg">School Principal</p>
                                <p className="text-sm text-white/80">Empowering Education</p>
                            </div>
                        </div>
                        <p className="text-sm text-white/80 mt-4 italic p-3 rounded-lg bg-white/5 border border-white/10">
                            "The best decision we made for our institution. Streamlined operations, happy parents, and excellent results."
                        </p>
                    </div>
                </div>
                        ...
                        <div className="flex items-center justify-between">
                            {/* <label className="flex items-center gap-2 cursor-pointer group">
                                <input
                                    ...
                                    className="w-4 h-4 bg-gray-800 border-gray-700 rounded focus:ring-blue-500 text-blue-500
